                                ...
                                <div className='item'>
                                    <div className='text'>
                                        <div className='ct ct-1 active'>
                                            ...
                                            <div className='content'>
                                                Khóa học quá tuyệt vời, đầy đủ
                                                kiến thức lại còn được bonus
                                                thêm những kỹ năng tìm lỗi và
                                        ...
                                        <div className='ct ct-3'>
                                            ...
                                            <div className='content'>
                                                ...
                                                sollicitudin libero id magna
                                                finibus, in maximus urna
                                                tincidunt. Nam at leo lacinia,
                                                interdum dolor in, molestie
                                                lectus. Aenean porttitor purus
                                                at purus euismod tristique
                                            </div>
                                            <div className='bottom'>
                                                <a href='#' target='_blank'>
                                                    <img
                ...
                <section className='section-gallery'>
                    ...
                    <div className='list'>
                        <div className='item'>
                            <div>
                                <img
                                    data-flickity-lazyload='/img/img_team1.jpg'
                                    alt=''
                                />
                            </div>
                            <div>
                                <img
                                    data-flickity-lazyload='/img/img_team2.jpg'
                                    alt=''
                                />
                            </div>
                            <div>
                                <img
                                    data-flickity-lazyload='./img/img_team3.jpg'
                                    alt=''
                                />
                            </div>
                            <div>
                                <img
                                    data-flickity-lazyload='./img/img_team4.jpg'
                                    alt=''
                                />
                            </div>
                            <div>
                                <img
                                    data-flickity-lazyload='./img/img_team5.jpg'
                                    alt=''
                                />
                            </div>
                            <div>
                                <img
                                    data-flickity-lazyload='./img/img_team6.jpg'
                                    alt=''
                                />
                            </div>
                            <div>
                                <img
                                    data-flickity-lazyload='./img/img_team7.jpg'
                                    alt=''
                                />
                            </div>
                        </div>
                        <div className='item'>
                            <div>
                                <img
                                    data-flickity-lazyload='./img/img_team8.jpg'
                                    alt=''
                                />
                            </div>
                            <div>
                                <img
                                    data-flickity-lazyload='./img/img_team9.jpg'
                                    alt=''
                                />
                            </div>
                            <div>
                                <img
                                    data-flickity-lazyload='./img/img_team10.jpg'
                                    alt=''
                                />
                            </div>
                            <div>
                                <img
                                    data-flickity-lazyload='./img/img_team11.jpg'
                                    alt=''
                                />
                            </div>
                            <div>
                                <img
                                    data-flickity-lazyload='./img/img_team12.jpg'
                                    alt=''
                                />
                            </div>
                            <div>
                                <img
                                    data-flickity-lazyload='./img/img_team13.jpg'
                                    alt=''
                                />
                            </div>
                            <div>
                        ...
                        <div className='item'>
                            ...
                            <div>
                                <img
                                    data-flickity-lazyload='./img/img_team16.jpg'
                                    alt=''
                                />
                            </div>
                            <div>
                            ...
                            <div>
                                <img
                                    data-flickity-lazyload='./img/img_team18.jpg'
                                    alt=''
                                />
                            </div>
                            <div>
                                <img
                                    data-flickity-lazyload='./img/img_team19.jpg'
                                    alt=''
                                />
                            </div>
                            <div>
                                <img
                                    data-flickity-lazyload='./img/img_team20.jpg'
                                    alt=''
                                />
                            </div>
                            <div>
                                <img
                                    data-flickity-lazyload='./img/img_team21.jpg'
                                    alt=''
                                />
                            </div>
                        </div>
